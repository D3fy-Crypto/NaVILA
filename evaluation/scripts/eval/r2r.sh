...
GRU_CKPT_PATH=${5:-"/home/rithvik/NaVILA_Env/brain_inspired/NaVILA/evaluation/checkpoints/motion_gru_infonce.pt"}
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    ...
    GRU_CKPT_PATH="$GRU_CKPT_PATH" CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python run.py \
