...
# SFT with 8 frames + MotionGRU integration
# This script trains the mm_projector and grid_to_vision projector with pose delta input

OUTPUT="./checkpoints/navila-8b-8f-sft-gru"
